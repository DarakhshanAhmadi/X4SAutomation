class X4AInputOrder:
    def __init__(self, feature_file_name, reseller_bcn, im_order_number, order_type, reseller_po, vendor_name, order_status, customer_po, total_revenue_min, total_revenue_max, customer_name,
                 ...
                 fraud_cancel_order_confirmation_id, fraud_reprocess_order_confirmation_id, data_errors_resubmit_order_confirmation_id, reseller_name, end_user_name, created_on,
                 filter_order_type, filter_order_status,   modify_reference_details_data_errors_order_id, modify_shipping_notes_data_errors_order_id, modify_vmf_details_data_errors_order_id,
        ...
        self.modify_reference_details_data_errors_order_id = modify_reference_details_data_errors_order_id
        self.modify_shipping_notes_data_errors_order_id = modify_shipping_notes_data_errors_order_id
        self.modify_vmf_details_data_errors_order_id = modify_vmf_details_data_errors_order_id
        self.modify_end_user_details_data_errors_order_id = modify_end_user_details_data_errors_order_id

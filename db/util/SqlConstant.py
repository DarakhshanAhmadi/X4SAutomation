class SqlConstant:
    ...
    X4A_INVENTORY_INSERT_SQL_QUERY = "INSERT INTO x4a_inventory(" \
                                               "feature_file_name, under_performing_sku, under_performing_mfn_part_number, vendor_business_manager, vendor_name, country, actions, comment, aging_sku, aging_mfn_part_number, update_action, update_comment)" \
                                               "VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)"

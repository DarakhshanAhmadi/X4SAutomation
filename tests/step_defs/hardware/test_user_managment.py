...
# from pages.X4A.TestSteps.userValidateData import UserValidateData
#
...
#     User_data_steps = UserValidateData(init_driver)
#     try:
#         if not User_data_steps.do_search_associate(feature_file_name, screen_shot):
#             raise Exception("Failed to search Associate")
#         init_driver.refresh()
#     except Exception as e:
#         logger.error("Error while searching Associate %s", e)
...
#     User_data_steps = UserValidateData(init_driver)
#     try:
#         if not User_data_steps.do_manage_associate_role(feature_file_name, screen_shot):
...
#     User_data_steps = UserValidateData(init_driver)
#     try:
#         if not User_data_steps.do_manage_associate_country(feature_file_name, screen_shot):
...
#     User_data_steps = UserValidateData(init_driver)
#     try:
#         if not User_data_steps.do_add_associate_country(feature_file_name, screen_shot):

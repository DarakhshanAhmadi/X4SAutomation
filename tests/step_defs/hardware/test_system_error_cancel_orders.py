...
@scenario("features/hardware/system_error_cancel_orders.feature", "Login to X4A portal")
def test_login_the_x4a_portal():
    pass


@scenario("features/hardware/system_error_cancel_orders.feature", "Verify Cancel order button for more than one record")
def test_error_list():
    pass


@scenario("features/hardware/system_error_cancel_orders.feature", "Verify Cancel order button for one record")
def test_single_record_error_list():
    pass


@scenario("features/hardware/system_error_cancel_orders.feature", "Verify on click Yes, Cancel order button")
def test_cancel_order_popup():
    pass


@scenario("features/hardware/system_error_cancel_orders.feature", "Verify on click cancel order button without giving reason")
...
@scenario("features/hardware/system_error_cancel_orders.feature", "logout X4A")
def test_logout_x4a():
    pass
...
def launch_browser(init_driver):
    ...
    try:
        ...
        filtered_order_data = validate_order_exception_data.filtered_orders_by_feature_file(test_data_order, feature_file_name)
...
def multiple_record_system_error_list(init_driver):
    ...
    validate_order_exception_data = ValidateOrderExceptionData(init_driver)
    try:
        if not validate_order_exception_data.select_multiple_record(feature_file_name, screen_shot):
...
def status_of_disabled_cancel_button(init_driver):
    ...
    status = 'disabled'
    try:
        if not validate_order_exception_data.do_verify_cancel_button(feature_file_name, screen_shot, status):
...
def single_record_system_error_list(init_driver):
    ...
    validate_order_exception_data = ValidateOrderExceptionData(init_driver)
    try:
        if not validate_order_exception_data.single_record_list(feature_file_name, screen_shot):
...
def do_click_cancel_button(init_driver):
    ...
    validate_order_exception_data = ValidateOrderExceptionData(init_driver)
    try:
        if not validate_order_exception_data.do_click_cancel_button(feature_file_name, screen_shot):
...
def verify_cancel_order_popup(init_driver):
    ...
    validate_order_exception_data = ValidateOrderExceptionData(init_driver)
    try:
        if not validate_order_exception_data.do_verify_cancel_order_popup(feature_file_name, screen_shot):
...
def do_click_no_cancel_button(init_driver):
    ...
    validate_order_exception_data = ValidateOrderExceptionData(init_driver)
    try:
        if not validate_order_exception_data.do_click_no_cancel_button(feature_file_name, screen_shot):
...
def verify_error_details_page(init_driver):
    ...
    validate_order_exception_data = ValidateOrderExceptionData(init_driver)
    try:
        if not validate_order_exception_data.do_verify_error_details_page(feature_file_name, screen_shot):
...
def do_click_yes_cancel_button(init_driver):
    ...
    validate_order_exception_data = ValidateOrderExceptionData(init_driver)
    try:
        if not validate_order_exception_data.do_click_yes_cancel_button(feature_file_name, screen_shot):
...
def verify_cancel_order_popup_after_yes(init_driver):
    ...
    validate_order_exception_data = ValidateOrderExceptionData(init_driver)
    try:
        if not validate_order_exception_data.verify_cancel_order_popup_after_yes(feature_file_name, screen_shot):
...
def do_click_back_cancel_button(init_driver):
    ...
    validate_order_exception_data = ValidateOrderExceptionData(init_driver)
    try:
        if not validate_order_exception_data.do_click_back_cancel_button(feature_file_name, screen_shot):
...
def do_cancel_order_without_reason(init_driver):
    ...
    validate_order_exception_data = ValidateOrderExceptionData(init_driver)
    try:
        if not validate_order_exception_data.do_cancel_order_without_reason(feature_file_name, screen_shot):
...
def verify_cancel_order_message(init_driver):
    ...
    validate_order_exception_data = ValidateOrderExceptionData(init_driver)
    try:
        if not validate_order_exception_data.do_verify_cancel_order_message(feature_file_name, screen_shot):
...
#     validate_order_exception_data = ValidateOrderExceptionData(init_driver)
#     try:
#         if not validate_order_exception_data.do_cancel_order_with_reason(feature_file_name, screen_shot):
...
#     validate_order_exception_data = ValidateOrderExceptionData(init_driver)
#     try:
#         if not validate_order_exception_data.do_cancel_order_success_message(feature_file_name, screen_shot):

...
from pages.X4A.Pages.X4AOrdersOrderException import X4AOrderExceptionPage


class ValidateOrderExceptionData:
    ...
    def click_on_order_exception(self, feature_file_name, screen_shot):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            x4a_order_exception.go_to_order_exception()
            self.logger.info("Successfully clicked on Order Exception")
            self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\success\\" + feature_file_name
                                        + "_order_exception_clicked_successfully.png")
            return True
        except Exception as e:
            self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\error\\" + feature_file_name +
                                        "_order_exception_clicking_error.png")
            screen_shot["path"] = self.screen_shot_path + "\\X4A\\error\\" + feature_file_name + \
                                  "_order_exception_clicking_error.png"
            self.logger.error("Error while clicking on Order Exception")
            self.logger.exception(e)
            return False
    ...
    def select_multiple_record(self, feature_file_name, screen_shot):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            x4a_order_exception.select_multiple_record()
    ...
    def single_record_list(self, feature_file_name, screen_shot):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            x4a_order_exception.single_record_list()
    ...
    def do_verify_cancel_button(self, feature_file_name, screen_shot, status):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            x4a_order_exception.do_verify_cancel_button(status)
    ...
    def do_click_cancel_button(self, feature_file_name, screen_shot):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            x4a_order_exception.do_click_cancel_button()
    ...
    def do_verify_cancel_order_popup(self, feature_file_name, screen_shot):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            x4a_order_exception.do_verify_cancel_order_popup()
    ...
    def do_click_no_cancel_button(self, feature_file_name, screen_shot):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            x4a_order_exception.do_click_no_cancel_button()
    ...
    def do_verify_error_details_page(self, feature_file_name, screen_shot):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            x4a_order_exception.do_verify_error_details_page()
    ...
    def do_click_yes_cancel_button(self, feature_file_name, screen_shot):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            x4a_order_exception.do_click_yes_cancel_button()
    ...
    def verify_cancel_order_popup_after_yes(self, feature_file_name, screen_shot):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            x4a_order_exception.verify_cancel_order_popup_after_yes()
    ...
    def do_click_back_cancel_button(self, feature_file_name, screen_shot):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            x4a_order_exception.do_click_back_cancel_button()
    ...
    def do_cancel_order_without_reason(self, feature_file_name, screen_shot):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            x4a_order_exception.do_cancel_order_without_reason()
    ...
    def do_verify_cancel_order_message(self, feature_file_name, screen_shot):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            x4a_order_exception.do_verify_cancel_order_message()
    ...
    def do_cancel_order_with_reason(self, feature_file_name, screen_shot):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            x4a_order_exception.do_cancel_order_with_reason()
    ...
    def do_cancel_order_success_message(self, feature_file_name, screen_shot):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            x4a_order_exception.do_cancel_order_success_message()
            self.logger.info("Successfully verified cancel order message")
            self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\success\\" + feature_file_name
                                        + "_cancel_order_message_verify_successfully.png")
            return True
    ...
    def logout_x4a_url(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.logout_x4a():
    ...
    def is_fraud_orders_tab_visible(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_verify_fraud_orders_tab():
    ...
    def search_and_select_order(self, feature_file_name, confirmation_id):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_search_and_select_order(confirmation_id):
    ...
    def is_reprocess_order_button_visible(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_verify_reprocess_order_button():
    ...
    def do_click_reprocess_order_button(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_click_reprocess_order_button():
                self.logger.error("Failed to verify Reprocess Order Button")
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\error\\" + feature_file_name
    ...
    def do_verify_reprocess_order_popup(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_verify_reprocess_order_popup():
    ...
    def do_click_reprocess_order_review_button(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_click_Reprocess_Order_Review_button():
    ...
    def do_verify_order_details_page(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_verify_order_details_page():
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\error\\" + feature_file_name +
    ...
    def do_click_reprocess_order_yes_button(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_click_Reprocess_Order_Yes_button():
    ...
    def do_reprocess_order_success_message(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_reprocess_order_success_message():
    ...
    def do_verify_order_in_list(self, feature_file_name, confirmation_id):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_verify_order_in_list(confirmation_id):
    ...
    def is_fraud_cancel_order_button_visible(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_verify_fraud_cancel_order_button():
    ...
    def do_click_cancel_order_button(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_click_cancel_order_button():
    ...
    def do_verify_fraud_cancel_order_popup(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_verify_fraud_cancel_order_popup():
    ...
    def do_click_fraud_yes_cancel_button(self, feature_file_name, screen_shot):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_click_fraud_yes_cancel_button():
    ...
    def search_and_select_data_errors_order(self, feature_file_name, confirmation_id):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_search_and_select_data_error_order(confirmation_id):
    ...
    def is_resubmit_order_button_visible(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_verify_data_error_resubmit_order_button():
    ...
    def update_reseller_po_data_error_order(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.update_reseller_po_data_error_order():
    ...
    def update_end_customer_order_data_error_order(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.update_end_customer_order_data_error_order():
    ...
    def do_click_resubmit_order_button(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_click_resubmit_order_button():
    ...
    def do_verify_content_of_resubmit_order_popup(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.verify_content_of_resubmit_order_popup():
    ...
    def do_click_resubmit_order_review_button(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_click_resubmit_order_review_button():
    ...
    def do_click_resubmit_order_yes_button(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_click_resubmit_order_yes_button():
    ...
    def do_resubmitted_order_success_message(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_resubmitted_order_success_message():
    ...
    def do_verify_data_error_order_in_list(self, feature_file_name, confirmation_id):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_verify_data_error_order_in_list(confirmation_id):
    ...
    def is_reference_details_edit_icon_visible(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_verify_reference_details_edit_icon():
    ...
    def do_verify_contents_of_edit_reference_details(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.verify_contents_of_edit_reference_details():
    ...
    def do_verify_more_than_eighteen_char_in_po_field(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.verify_more_than_eighteen_char_in_po_field():
    ...
    def do_verify_po_number_invalid_message(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.verify_po_number_invalid_message():
    ...
    def do_verify_more_than_eighteen_char_in_end_customer_order_field(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.verify_more_than_eighteen_char_in_end_customer_order_field():
                self.logger.error(
    ...
    def do_verify_end_customer_order_number_invalid_message(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.verify_end_customer_order_number_invalid_message():
                self.logger.error(
    ...
    def do_verify_modified_data_after_click_on_x_icon(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.verify_modified_data_after_click_on_x_icon():
                self.logger.error(
    ...
    def do_verify_modified_data_after_click_on_cancel_button(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.verify_modified_data_after_click_on_cancel_button():
                self.logger.error(
    ...
    def do_verify_updated_po_and_end_customer_order_data(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_verify_updated_po_and_end_customer_order_data():
                self.logger.error(
    ...
    def is_shipping_notes_edit_icon_visible(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_verify_shipping_notes_edit_icon():
    ...
    def do_verify_contents_of_edit_shipping_notes(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.verify_contents_of_edit_shipping_notes():
    ...
    def click_on_x_icon(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.click_on_x_icon():
    ...
    def click_on_cancel_button(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.click_on_cancel_button():
    ...
    def do_validate_maximum_limit_message(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_validate_maximum_limit_message():
    ...
    def do_validate_updated_shipping_notes_data(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_validate_updated_shipping_notes_data():
                self.logger.error(
    ...
    def do_click_filter_icon(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_click_filter_icon():
    ...
    def do_verify_filter_options(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_verify_filter_options():
    ...
    def do_verify_order_entry_method_options_list(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_verify_order_entry_method_options_list():
    ...
    def do_verify_country_options_list(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_verify_country_options_list():
    ...
    def do_verify_clear_all_button(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_verify_clear_all_button():
    ...
    def do_verify_selected_options_ord_entry_mtd_on_header(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_verify_selected_options_ord_entry_mtd_on_header():
                self.logger.error(
    ...
    def do_select_order_entry_method(self, feature_file_name, order_entry_method):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_select_order_entry_method(order_entry_method):
    ...
    def do_verify_update_data_grid_as_per_order_entry_method_filter(self, feature_file_name, order_entry_method):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_verify_update_data_grid_as_per_order_entry_method_filter(order_entry_method):
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\error\\" + feature_file_name
    ...
    def do_select_country(self, feature_file_name, country):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_select_country(country):
    ...
    def do_verify_update_data_grid_as_per_country_filter(self, feature_file_name, country):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_verify_update_data_grid_as_per_country_filter(country):
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\error\\" + feature_file_name
                                            + "_updated_data_grid_failed.png")
                return False
            else:
    ...
    def do_click_clear_all_button(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_click_clear_all_button():
    ...
    def do_select_option_from_ord_entry_method_and_country(self, feature_file_name, order_entry_method, country):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_select_option_from_ord_entry_method_and_country(order_entry_method, country):
    ...
    def do_verify_selected_values_cleared_from_filter_header(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_verify_selected_values_cleared_from_filter_header():
                self.logger.error(
    ...
    def is_vmf_details_edit_icon_visible(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_verify_vmf_details_edit_icon():
    ...
    def do_verify_contents_of_edit_vmf_details(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.verify_contents_of_edit_vmf_details():
    ...
    def do_verify_attribute_value_allow_special_character(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.verify_attribute_value_allow_special_characters():
    ...
    def do_validate_vmf_saved_data(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_validate_vmf_saved_data():
    ...
    def do_validate_vmf_data_not_saved(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_validate_vmf_data_not_saved():
    ...
    def do_validate_modified_vmf_data_not_updated(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_validate_modified_vmf_data_not_updated():
                self.logger.error(
    ...
    def is_end_user_details_edit_icon_visible(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_verify_end_user_details_edit_icon():
    ...
    def do_verify_contents_of_edit_end_user_details(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.verify_contents_of_edit_end_user_details():
    ...
    def do_verify_edit_button_and_save_button_enable(self, feature_file_name, end_user_with_suffix):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_verify_edit_button_and_save_button_enable(end_user_with_suffix):
                self.logger.error(
    ...
    def do_verify_selected_end_user_info_on_order_details_page(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_verify_selected_end_user_info_on_order_details_page():
                self.logger.error(
    ...
    def do_verify_contents_of_selected_end_user_with_suffix_edit_popup(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_verify_contents_of_selected_end_user_with_suffix_edit_popup():
    ...
    def do_verify_modified_end_user_info_on_order_details_page(self, feature_file_name, end_user):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_verify_modified_end_user_info_on_order_details_page(end_user):
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\error\\" + feature_file_name
    ...
    def do_validate_message_for_mandatory_fields(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_validate_message_for_mandatory_fields():
    ...
    def do_verify_contents_of_edit_add_new_end_user(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.verify_contents_of_edit_add_new_end_user():
    ...
    def do_verify_customer_type_option_list(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.verify_customer_type_option_list():
    ...
    def do_verify_add_new_user_with_valid_data(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_verify_add_new_user_with_valid_data():
                self.logger.error(
    ...
    def do_verify_contents_of_edit_billing_address(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.verify_contents_of_edit_billing_address():
    ...
    def do_verify_order_details_page_after_click_on_x_icon(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_verify_order_details_page_after_click_on_x_icon():
                self.logger.error(
    ...
    def do_verify_order_details_page_after_click_on_cancel_button(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_verify_order_details_page_after_click_on_cancel_button():
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\error\\" + feature_file_name
    ...
    def do_search_with_special_character(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_search_with_special_character():
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\error\\" + feature_file_name
    ...
    def do_search_with_valid_suffix(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_search_with_valid_suffix():
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\error\\" + feature_file_name
    ...
    def do_select_searched_addr_and_save_button_enabled(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_select_searched_addr_and_save_button_enabled():
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\error\\" + feature_file_name
    ...
    def do_verify_selected_billing_addr_on_order_details_page(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_verify_selected_billing_addr_on_order_details_page():
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\error\\" + feature_file_name
    ...
    def do_verify_order_line_remove_icon(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_verify_order_line_remove_icon():
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\error\\" + feature_file_name
    ...
    def do_click_on_mark_for_cancel_and_line_not_editable(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_click_on_mark_for_cancel_and_line_not_editable():
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\error\\" + feature_file_name
    ...
    def do_click_on_unmark_for_cancel_and_line_is_editable(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_click_on_unmark_for_cancel_and_line_is_editable():
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\error\\" + feature_file_name
    ...
    def do_verify_order_resubmitted_successfully(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_verify_order_resubmitted_successfully():
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\error\\" + feature_file_name
    ...
    def do_click_on_mark_for_cancel_from_dropdown_and_line_grey_out(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_click_on_mark_for_cancel_from_dropdown_and_line_grey_out():
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\error\\" + feature_file_name
                                            + "_click_on_mark_for_cancel_and_line_not_editable_failed.png")
                return False
            else:
    ...
    def do_click_on_unmark_for_cancel_from_dropdown_and_line_get_unable(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_click_on_unmark_for_cancel_from_dropdownn_and_line_get_unable():
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\error\\" + feature_file_name
                                            + "_click_on_unmark_for_cancel_and_line_is_editable_failed.png")
                return False
            else:
    ...
    def do_verify_atleast_one_order_line_required_message(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_verify_atleast_one_order_line_required_message():
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\error\\" + feature_file_name
    ...
    def do_verify_last_order_attempt_on_section(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_verify_last_order_attempt_on_section():
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\error\\" + feature_file_name
    ...
    def do_verify_created_on_section(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_verify_created_on_section():
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\error\\" + feature_file_name
    ...
    def do_verify_contents_of_last_order_attempt_on_section(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_verify_contents_of_last_order_attempt_on_section():
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\error\\" + feature_file_name
    ...
    def do_verify_contents_of_created_on_section(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_verify_contents_of_created_on_section():
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\error\\" + feature_file_name
    ...
    def do_verify_last_ord_attempt_on_sec_calender_open_and_able_to_select_date(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_verify_last_ord_attempt_on_sec_calender_open_and_able_to_select_date():
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\error\\" + feature_file_name
    ...
    def do_verify_created_on_sec_calender_open_and_able_to_select_date(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_verify_created_on_sec_calender_open_and_able_to_select_date():
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\error\\" + feature_file_name
    ...
    def do_verify_last_ord_attempt_on_data_get_filter_as_per_selected_date_range(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_verify_last_ord_attempt_on_data_get_filter_as_per_selected_date_range_in_pages():
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\error\\" + feature_file_name
    ...
    def do_verify_created_on_data_get_filter_as_per_selected_date_range(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_verify_created_on_data_get_filter_as_per_selected_date_range_in_pages():
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\error\\" + feature_file_name
    ...
    def verify_filter_by_last_ord_attempt_on_data_by_selecting_30_days_in_pages(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.verify_filter_by_last_ord_attempt_on_data_by_selecting_30_days_in_pages():
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\error\\" + feature_file_name
    ...
    def verify_filter_by_created_on_data_by_selecting_30_days_in_pages(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.verify_filter_by_created_on_data_by_selecting_30_days_in_pages():
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\error\\" + feature_file_name
    ...
    def do_verify_order_line_edit_icon(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_verify_order_line_edit_icon():
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\error\\" + feature_file_name
    ...
    def do_verify_update_and_cancel_icon(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_verify_update_and_cancel_icon():
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\error\\" + feature_file_name
    ...
    def do_verify_editable_order_line_fields(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_verify_editable_order_line_fields():
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\error\\" + feature_file_name
    ...
    def do_verify_order_line_updated_data_discarded(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_verify_order_line_updated_data_discarded():
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\error\\" + feature_file_name
    ...
    def do_verify_order_line_fields_not_allow_non_numberic_content(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_verify_order_line_fields_not_allow_non_numberic_content():
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\error\\" + feature_file_name
    ...
    def do_update_order_line_field_value(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_update_order_line_field_value():
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\error\\" + feature_file_name
    ...
    def do_verify_operator_id(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_verify_operator_id():
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\error\\" + feature_file_name
    ...
    def do_verify_channel_label(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_verify_channel_label():
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\error\\" + feature_file_name
    ...
    def do_verify_order_channel_matched(self, feature_file_name, confirmation_id):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_verify_order_channel_matched(confirmation_id):
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\error\\" + feature_file_name
    ...
    def do_verify_shipping_details(self, feature_file_name, confirmation_id):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_verify_shipping_details(confirmation_id):
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\error\\" + feature_file_name
                                            + "_verify_shipping_details_failed.png")
                return False
            else:
                self.logger.info(
                    "Successfully Verified Shipping Details should display")
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\success\\" + feature_file_name
                                            + "_verify_shipping_details_successfully.png")
                return True
        except Exception as e:
            self.logger.exception(e)
            return False

    def do_verify_contents_of_edit_shipping_address(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.verify_contents_of_edit_shipping_address():
                self.logger.error("Failed to verify contents of Edit Shipping Address popup")
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\error\\" + feature_file_name
                                            + "_contents_of_edit_shipping_address_failed.png")
                return False
            else:
                self.logger.info("Successfully verified contents of Edit Shipping Address popup")
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\success\\" + feature_file_name
                                            + "_contents_of_edit_shipping_address_successfully.png")
                return True
        except Exception as e:
            self.logger.exception(e)
            return False

    def do_verify_order_details_page_after_click_on_x_icon_shipping_addr_popup(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_verify_order_details_page_after_click_on_x_icon_shipping_addr_popup():
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\error\\" + feature_file_name
                                            + "_verify_order_details_page_after_click_on_x_icon_failed.png")
                return False
            else:
                self.logger.info(
                    "Successfully Clicked on X icon on shipping address popup and Verified Order Details page should display")
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\success\\" + feature_file_name
                                            + "_verify_order_details_page_after_click_on_x_icon_successfully.png")
                return True
        except Exception as e:
    ...
    def do_verify_order_details_page_after_click_on_cancel_button_shipping_addr_popup(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_verify_order_details_page_after_click_on_cancel_button_shipping_addr_popup():
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\error\\" + feature_file_name
                                            + "_verify_order_details_page_after_click_on_cancel_button_failed.png")
                return False
            else:
                self.logger.info(
                    "Successfully Clicked on Cancel button on shipping address popup and Verified that Order Details page should display")
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\success\\" + feature_file_name
                                            + "_verify_order_details_page_after_click_on_cancel_button_successfully.png")
                return True
        except Exception as e:
    ...
    def do_verify_all_shipping_addr_matching_with_entered_text(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_verify_all_shipping_addr_matching_with_entered_text():
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\error\\" + feature_file_name
                                            + "_verify_all_addr_matching_with_entered_text_failed.png")
                return False
            else:
                self.logger.info(
                    "Successfully verified all shipping address matching with search entered text should get displayed")
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\success\\" + feature_file_name
                                            + "_verify_all_addr_matching_with_entered_text_successfully.png")
                return True
        except Exception as e:
    ...
    def do_verify_contents_of_add_new_shipping_address_popup(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_verify_contents_of_add_new_shipping_address_popup():
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\error\\" + feature_file_name
                                            + "_contents_of_add_new_shipping_address_popup_failed.png")
                return False
            else:
                self.logger.info("Successfully verified contents of Add new Shipping Address popup")
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\success\\" + feature_file_name
                                            + "_contents_of_add_new_shipping_address_popup_successfully.png")
                return True
        except Exception as e:
            self.logger.exception(e)
            return False

    def do_verify_added_new_shipping_addr_data(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_verify_added_new_shipping_addr_data():
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\error\\" + feature_file_name
                                            + "_verify_added_new_shipping_addr_data_popup_failed.png")
                return False
            else:
                self.logger.info("Successfully verified added new shipping address data should display")
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\success\\" + feature_file_name
                                            + "_verify_added_new_shipping_addr_data_successfully.png")
                return True
        except Exception as e:
            self.logger.exception(e)
            return False

    def do_verify_data_not_save_after_click_on_x_icon_on_popup(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_verify_data_not_save_after_click_on_x_icon_on_popup():
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\error\\" + feature_file_name
                                            + "_verify_data_not_save_after_click_on_x_icon_on_popup_failed.png")
                return False
            else:
                self.logger.info(
                    "Successfully Clicked on X icon on Add new shipping address popup and Verified that entered data should not get saved")
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\success\\" + feature_file_name
                                            + "_verify_data_not_save_after_click_on_x_icon_on_popup_successfully.png")
                return True
        except Exception as e:
            self.logger.exception(e)
            return False

    def do_verify_data_not_save_after_click_on_cancel_icon_on_popup(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_verify_data_not_save_after_click_on_cancel_icon_on_popup():
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\error\\" + feature_file_name
                                            + "_verify_data_not_save_after_click_on_cancel_icon_on_popup_failed.png")
                return False
            else:
                self.logger.info(
                    "Successfully Clicked on Cancel button on Add new shipping address popup and Verified entered data should not get saved")
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\success\\" + feature_file_name
                                            + "_verify_data_not_save_after_click_on_cancel_icon_on_popup_successfully.png")
                return True
        except Exception as e:
            self.logger.exception(e)
            return False

    def do_correct_PO_and_resubmit_order(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_correct_PO_and_resubmit_order():
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\error\\" + feature_file_name
                                            + "_correct_PO_and_resubmit_order_failed.png")
                return False
            else:
                self.logger.info(
                    "Successfully Corrected the PO# and resubmited the order")
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\success\\" + feature_file_name
                                            + "_correct_PO_and_resubmit_order_successfully.png")
                return True
        except Exception as e:
            self.logger.exception(e)
            return False

    def do_correct_PO_add_new_line_and_resubmit_order_cancel_proceed_button(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_correct_PO_add_new_line_and_resubmit_order_cancel_proceed_button():
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\error\\" + feature_file_name
                                            + "_correct_PO_add_new_line_and_resubmit_order_cancel_proceed_button_failed.png")
                return False
            else:
                self.logger.info(
                    "Successfully Corrected the PO# and Add new line then Verified Resubmit Order message and Cancel and Proceed button")
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\success\\" + feature_file_name
                                            + "_correct_PO_add_new_line_and_resubmit_order_cancel_proceed_button_successfully.png")
                return True
        except Exception as e:
            self.logger.exception(e)
            return False

    def do_click_cancel_button_and_verify_reject_reason_open(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_click_cancel_button_and_verify_reject_reason_open():
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\error\\" + feature_file_name
                                            + "_click_cancel_button_and_verify_reject_reason_open_failed.png")
                return False
            else:
                self.logger.info(
                    "Successfully Clicked on Cancel Order button then popup should opened to enter reject reason")
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\success\\" + feature_file_name
                                            + "_click_cancel_button_and_verify_reject_reason_open_successfully.png")
                return True
        except Exception as e:
            self.logger.exception(e)
            return False

    def do_click_proceed_button_and_resubmit_the_order(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_click_proceed_button_and_resubmit_the_order():
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\error\\" + feature_file_name
                                            + "_click_proceed_button_and_resubmit_the_order_failed.png")
                return False
            else:
                self.logger.info(
                    "Successfully Clicked on Proceed button and resubmit the order")
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\success\\" + feature_file_name
                                            + "_click_proceed_button_and_resubmit_the_order_successfully.png")
                return True
        except Exception as e:
            self.logger.exception(e)
            return False
    ...
    def do_correct_end_customer_po_and_resubmit_order_cancel_proceed_button(self, feature_file_name):
        x4a_order_exception = X4AOrderExceptionPage(self.driver)
        try:
            if not x4a_order_exception.do_correct_end_customer_po_and_resubmit_order_cancel_proceed_button():
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\error\\" + feature_file_name
                                            + "_correct_end_customer_po_and_resubmit_order_cancel_proceed_button_failed.png")
                return False
            else:
                self.logger.info(
                    "Successfully Corrected the End Customer order# then Verified Resubmit Order message and Cancel and Proceed button")
                self.driver.save_screenshot(self.screen_shot_path + "\\X4A\\success\\" + feature_file_name
